...
object NavigationUtils {
    ...
    private fun isHasNavigationBar(context: Context): Boolean {
        ...
        if (displayHeight > displayWidth) {
            if (displayHeight + StatusBarUtil.getNavigationBarHeight(context) > realHeight) return false
        } else {
            if (displayWidth + StatusBarUtil.getNavigationBarHeight(context) > realWidth) return false
        }
